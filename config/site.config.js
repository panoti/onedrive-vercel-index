...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'dende@namek.edu.vn',
  ...
  title: process.env.NEXT_PUBLIC_TITLE || "Dende's OneDrive",
  ...
  email: 'mailto:dende@namek.edu.vn',
